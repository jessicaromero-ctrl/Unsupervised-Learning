...
# Crear una nueva columna llamada video_game_lover
# Establecer el valor en 1 si un estudiante jugaba mas de 7hrs a la semana
# de videojuegos
df_wide_filled["video_game_lover"] = (df_wide_filled["video_games"] > 7).astype(int)
